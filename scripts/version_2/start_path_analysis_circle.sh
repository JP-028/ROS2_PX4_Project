...
echo "[INFO] Starting circle path analysis"
...
echo
echo "[INFO] Now start the circle flight in another terminal:"
echo "       ./scripts/version_2/start_circle_flight.sh"
echo
echo "[INFO] When the flight is finished, stop this analyzer with Ctrl+C."
echo "[INFO] Results will be saved in:"
echo "       path_analysis/<date>_<time>_circle/"
echo

./scripts/version_2/analyze_path_from_odometry.py --mode circle --diameter 5.0
