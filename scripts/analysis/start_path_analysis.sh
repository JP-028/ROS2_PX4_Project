...
if [ -z "$SPEC_FILE" ]; then
  ...
  echo
  echo "Usage:"
  echo "  ./scripts/analysis/start_path_analysis.sh path_specs/circle_3m.yaml"
  echo "  ./scripts/analysis/start_path_analysis.sh path_specs/square_3m.yaml"
  echo
  exit 1
fi
...
./scripts/analysis/analyze_path_from_spec.py "$SPEC_FILE"
